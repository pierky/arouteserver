...
from .base import BasicScenarioOpenBGPDRFC8950
...
class BasicScenario_OpenBGPDRFC8950(BasicScenario_Data6, BasicScenarioOpenBGPDRFC8950):

    __test__ = True

    SHORT_DESCR = "Live test, OpenBGPD {}, global scenario, RFC8950".format(

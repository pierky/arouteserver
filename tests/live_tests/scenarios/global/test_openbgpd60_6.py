...
from .base import BasicScenarioOpenBGPD60
...
class BasicScenario_OpenBGPDIPv6(BasicScenario_Data6, BasicScenarioOpenBGPD60):

    __test__ = True
    SKIP_ON_TRAVIS = True

    SHORT_DESCR = "Live test, OpenBGPD 6.0, global scenario, IPv6"

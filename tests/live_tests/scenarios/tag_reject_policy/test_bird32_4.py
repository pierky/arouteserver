...
class TagRejectPolicyScenario_BIRD32IPv4(BasicScenario_Data4, TagRejectPolicyScenarioBIRD3):

    __test__ = True

    SHORT_DESCR = "Live test, BIRD v3.2, 'tag' reject policy scenario, IPv4"

...
class TagRejectPolicyScenario_BIRD32IPv6(BasicScenario_Data6, TagRejectPolicyScenarioBIRD3):

    __test__ = True

    SHORT_DESCR = "Live test, BIRD v3.2, 'tag' reject policy scenario, IPv6"

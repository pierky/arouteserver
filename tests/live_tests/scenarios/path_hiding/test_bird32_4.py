...
class PathHidingScenario_MitigationOn_BIRD32IPv4(PathHidingScenario_Data4,
    ...
    SHORT_DESCR = "Live test, BIRD v3.2, path hiding, mitigation on, IPv4"

class PathHidingScenario_MitigationOff_BIRD32IPv4(PathHidingScenario_Data4,
                                                 PathHidingScenario_MitigationOff,
                                                 PathHidingScenarioBIRD3):
    __test__ = True
    ...
    SHORT_DESCR = "Live test, BIRD v3.2, path hiding, mitigation off, IPv4"

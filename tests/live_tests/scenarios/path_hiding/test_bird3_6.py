...
class PathHidingScenario_MitigationOn_BIRD3IPv6(PathHidingScenario_Data6,
    ...
    SHORT_DESCR = "Live test, BIRD v3, path hiding, mitigation on, IPv6"

class PathHidingScenario_MitigationOff_BIRD3IPv6(PathHidingScenario_Data6,
                                                 PathHidingScenario_MitigationOff,
                                                 PathHidingScenarioBIRD3):
    __test__ = True
    ...
    SHORT_DESCR = "Live test, BIRD v3, path hiding, mitigation off, IPv6"

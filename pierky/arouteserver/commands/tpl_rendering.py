...
class TemplateRenderingCommands(ARouteServerCommand):
    ...
    def run(self):
        ...
        self.cfg_builder_params = {
            ...
            "bgpq3_timeout": program_config.get("bgpq3_timeout"),
...
class IRRASSetCommand(TemplateRenderingCommands):
    ...
    @classmethod
    def add_arguments(cls, parser):
        super(IRRASSetCommand, cls).add_arguments(parser)

        parser.add_argument(
            "--include-members",
            help="Comma-delimited list of members that will be always added to "
                 "the 'members' attribute of the object generated by this "
                 "command.",
            metavar="MEMBERS",
        ...
        parser.add_argument(
            "--exclude-members",
            help="Comma-delimited list of members that will never be included "
                 "in the 'members' attribute of the object generated by this "
                 "command.",
            metavar="MEMBERS",
            dest="exclude_members")

    def _set_cfg_builder_params(self):
        super(IRRASSetCommand, self)._set_cfg_builder_params()

        self.cfg_builder_params["include_members"] = self.args.include_members
        self.cfg_builder_params["exclude_members"] = self.args.exclude_members

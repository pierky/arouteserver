...
class OpenBGPD72PortableInstance(OpenBGPDPortableInstance):

    DOCKER_IMAGE = "pierky/openbgpd:7.2"

    TAG = "openbgpd72p"

    BGP_SPEAKER_VERSION = "7.2"
    TARGET_VERSION = "7.2"


class OpenBGPD73PortableInstance(OpenBGPDPortableInstance):

    DOCKER_IMAGE = "pierky/openbgpd:7.3"

    TAG = "openbgpd73p"

    BGP_SPEAKER_VERSION = "7.3"
    TARGET_VERSION = "7.3"


class OpenBGPD74PortableInstance(OpenBGPDPortableInstance):

    DOCKER_IMAGE = "pierky/openbgpd:7.4"

    TAG = "openbgpd74p"

    BGP_SPEAKER_VERSION = "7.4"
    TARGET_VERSION = "7.4"


class OpenBGPD75PortableInstance(OpenBGPDPortableInstance):

    DOCKER_IMAGE = "pierky/openbgpd:7.5"

    TAG = "openbgpd75p"

    BGP_SPEAKER_VERSION = "7.5"
    TARGET_VERSION = "7.5"
...
class OpenBGPD80PortableInstance(OpenBGPDPortableInstance):

    DOCKER_IMAGE = "pierky/openbgpd:8.0"

    TAG = "openbgpd80p"

    BGP_SPEAKER_VERSION = "8.0"
    TARGET_VERSION = "8.0"
...
class OpenBGPD84PortableInstance(OpenBGPDPortableInstance):

    DOCKER_IMAGE = "pierky/openbgpd:8.4"

    TAG = "openbgpd84p"

    BGP_SPEAKER_VERSION = "8.4"
    TARGET_VERSION = "8.4"
